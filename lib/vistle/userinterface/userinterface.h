...
public:
    ...
    bool sendMessage(const MessagePayload &msg);
    virtual bool handleMessage(const MessagePayload &msg) = 0;
...
protected:
    ...
    bool handleMessage(const MessagePayload &msg);
    ...
    bool m_locked = false;
    std::vector<MessagePayload> m_sendQueue;
