#ifndef VISTLE_USERINTERFACE_VISTLECONNECTION_H
#define VISTLE_USERINTERFACE_VISTLECONNECTION_H
...
public:
    ...
    bool sendMessage(const MessagePayload &msg) const;
...
struct V_UIEXPORT UiPythonStateAccessor: public vistle::PythonStateAccessor {
    ...
    bool sendMessage(const MessagePayload &m) override;
