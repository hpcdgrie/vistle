...
public:
    ...
    Payload getPayload() const
    {
        ...
        return message::getPayload<Payload>({payload(), payload() + payloadSize()});
    }
...
public:
    ...
    const std::shared_ptr<vistle::buffer> &accessPayload() const;
    std::shared_ptr<vistle::buffer> &accessPayload();
